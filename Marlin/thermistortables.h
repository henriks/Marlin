...
#if (THERMISTORHEATER_0 == 102) || (THERMISTORHEATER_1 == 102) || (THERMISTORHEATER_2 == 102) || (THERMISTORBED == 102) //no idea, from emaker huxley sprinter firmware
const short temptable_102[][2] PROGMEM = {
   {1*OVERSAMPLENR, 628},
   {32*OVERSAMPLENR, 254},
   {63*OVERSAMPLENR, 213},
   {94*OVERSAMPLENR, 191},
   {125*OVERSAMPLENR, 176},
   {156*OVERSAMPLENR, 165},
